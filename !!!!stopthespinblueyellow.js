...
function setup() {
  createCanvas(300, 300);//size of the test field
  //noLoop();
  frameRate(20);
  rectMode(CENTER);
...
function mousePressed() {
  loop();
  transx = floor(random(1,15))*20//sets the x spacing of targets
  transy = floor(random(1,15))*20//sets the y spacing of targets
